...
function RecipeCard({ recipe, variant = "default"}) {
    ...
    console.log("the log of recipi card " , data);
            ...
            <Link href={data.href}>
                <Card className="rounded-none overflow-hidden border-stone-200 hover:shadow-xl hover:-translate-y-1 transition-all duration-300 cursor-pointer group pt-0">
                    ...
                    <div className='relative aspect-square'>
                        ...
                        <div className='absolute inset-0 bg-linear-to-t from-black/60 via-transparent opacity-0 group-hover:opacity-100 transition-opacity'>
                        ...
                        <Badge
                            className={`${
                                data.matchPercentage >= 90
                                    ...
                                    ? " bg-orange-600 "
                                    : " bg-stone-600 "
                            }text-white text-lg px-4 py-4 shadow-lg`}
                        >
                            {data.matchPercentage}% 
                        </Badge>
