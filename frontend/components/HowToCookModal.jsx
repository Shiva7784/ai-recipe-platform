            ...
            <div>
                ...
                <div className="relative">
                    <input
                        ...
                        placeholder="e.g., Chicken Biryani, Chocolate Cake, Paste Carbonara"
                        className="w-full px-4 py-3 pr-12 border border-stone-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500 text-stone-900 placeholder:text-stone-400"
                        autoFocus
                    />
