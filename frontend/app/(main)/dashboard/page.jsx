import { getAreas, getCategories, getRecipeOfTheDay } from '@/actions/mealdb.actons'
                        ...
                        {areas.map((area , index) => (
                            <Link
                                ...
                                href={`/recipes/cuisine/${area.strArea
                                    ...
                                    .replace(/\s+/g,"-")}`}
                            >
                                <div className='bg-stone-50 p-6 border-2 border-stone-200 hover:border-orange-600 hover:shadow-lg transition-all group cursor-pointer'>
