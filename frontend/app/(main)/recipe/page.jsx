...
import { AlertCircle, ArrowLeft, Bookmark, BookmarkCheck, CheckCircle, CheckCircle2, ChefHat, CircleAlert, Clock, Download, Flame, Lightbulb, Loader2, Users } from 'lucide-react';
        ...
        return <div className='min-h-screen bg-stone-50 pt-24 pb-16 '>
            <div className='container mx-auto max-w-4xl text-center py-20'>
                ...
                <p className='text-stone-600 font-light'>
                    Our AI Chef crafting detailed instructions for{" "}
                    ...
                    <div className='bg-white p-8 md:p-10 border-2 border-stone-200 mb-6'>
                        ...
                        <div className='flex flex-wrap gap-3'>
                            <Button
                                ...
                                } text-white gap-2 transform-all`}
                            >
                                {saving || removing ? (
                                    <>
                        ...
                        <div className='bg-white p-6 border-2 border-stone-200 lg:sticky lg:top-24'>
                            ...
                            {Object.entries(
                                ...
                                <div key={category} className='mb-6 last:mb-0'>
                                    <h3 className='txt-sm font-bold text-stone-500 uppercase tracking-wide mb-3'>
                                        {category}
                                    </h3>

                                    <ul className='apace-y-2'>
