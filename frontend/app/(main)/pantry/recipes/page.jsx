...
function PantryRecipesPage() {
    ...
    //Load suggestions on count
    useEffect(() => {
        fetchSuggestions();
    },[]);

    const recipes = recipesData?.recipes || [];
    const ingredientsUsed = recipesData?.ingredientUsed || "";
    console.log("recipes used", ingredientsUsed);
    console.log("ingredients", ingredientsUsed);
    ...
    return (
        <div className='min-h-screen bg-stone-50 pt-24 pb-16 px-4'>
            <div className='container mx-auto max-w-6xl'>
                    ...
                    {recipesData !== undefined && (
                        <div className='bg-orange-50 p-4 border-2 border-orange-200 inline-flex items-center gap-3'>
                            ...
                            <div className='text-sm'>
                                {recipesData.recommendationLimit === "unlimited" ? (
                                    <>
                ...
                {/* Recipes Grid - Using Recipes Card component */}
                {!loading && recipes.length > 0 && (
                    <div>
                        <div className='flex items-center justify-between mb-6'>
                            ...
                            <Badge
                            variant='outline'
                            className="border-2 border-stone-900 font-bold uppercase tracking-wide"
                        >
                ...
                {!loading && recipesData === undefined && (
                    <div className='bg-linear-to-br from-orange-50 to-amber-50 p-12 text-center border-2 border-orange-200'>
                        ...
                        <p className='text-stone-600 mb-8 mx-auto font-light'>
                            You&apos;ve used to all your AI recipe recommendations this month.
