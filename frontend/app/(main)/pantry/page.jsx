                        ...
                        <div className='bg-linear-to-br from-green-600 to-emerald-500 text-white p-6 border-2 border-emerald-700 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer group'>
                            <div className='flex items-center gap-4'>
                                ...
                                <div className='hidden sm:block'>
                                    <Badge className="bg-white/29 text-white border-2 border-white/30 font-bold uppercase tracking-wide">
                                        {items.length} items
                                    </Badge>
                                </div>
                                ...
                                <div
                                    ...
                                    >
                                        ...
                                        <div className='space-y-3'>
                                            ...
                                            className='w-full px-3 py-2 border-2 border-stone-300 focus:outline-none focus:border-orange-600 text-sm'
